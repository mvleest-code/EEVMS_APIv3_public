...
def main():
    try:
        ...
        url = f"https://{base_url}/api/v3.0/media?deviceId={deviceId}&type=preview&mediaType=image&startTimestamp__gte={startTimestamp}&endTimestamp__lte={endTimestamp}&pageSize={pageSize}"
        ...
        if response.status_code == 200:
            ...
            for result in results:
                ...
                start_url = f"https://{media_url}/api/v3.0/media/recordedImage.jpeg?deviceId={deviceId}&type=preview&timestamp={startTimestamp1}"
                end_url = f"https://{media_url}/api/v3.0/media/recordedImage.jpeg?deviceId={deviceId}&type=preview&timestamp={endTimestamp1}"

                download_image(start_url, f"{deviceId}_{startTimestamp2}_preview_image.jpeg")
